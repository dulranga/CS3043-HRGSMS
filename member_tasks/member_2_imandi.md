...
| [ ] | M2-S03 | Create `booking` and `booking_status_history` using Member 1's guest/actor keys and approved enums. Done when invalid dates/statuses, guest FK and history FKs are tested; no booking writes until room assignment exists. |
